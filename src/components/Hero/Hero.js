    ...
    <section id="hero" className={styles.hero}>
      <div className={styles.inner}>
        <div className={styles.content}>
          ...
          <p className={styles.impact}>{personal.impact}</p>

          <div className={styles.ctas}>
            <Link href="/projects" className={styles.btnPrimary}>View Projects</Link>
            <Link href="/contact" className={styles.btnSecondary}>Contact Me</Link>
          </div>
          ...
          <div className={styles.socials}>
            ...
            <a href={personal.instagram} target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="Instagram">
            ...
            <a href={personal.youtube} target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="YouTube">
